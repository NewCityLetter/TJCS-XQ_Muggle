...
void GetPreMove()
{
    ...
    for(int i=3;i<12;i++)//子所在位置
    {
        for(int j=0;j<4096;j++)
        {
            ...
            preMove.cannonSupLine[i][j][0] = 0;
            preMove.cannonSupLine[i][j][1] = 0;
            ...
            for (k = k + 1; k < 12; k++)
            {
                if (j & (1 << k))
                {
                    preMove.cannonSupLine[i][j][1] = k;//Sup炮吃子
                    break;
                }
            }
           ...
           for(k=i-1;k>=3;k--)//向左寻找
            ...
            for (k = k - 1; k >= 3; k--)
            {
                if (j & (1 << k))
                {
                    preMove.cannonSupLine[i][j][0] = k;//Sup炮吃子
                    break;
                }
            }
    ...
    for(int i=3;i<13;i++)//子所在位置
    {
        for(int j=0;j<8192;j++)
        {
            ...
            preMove.cannonSupCol[i][j][0] = 0;
            preMove.cannonSupCol[i][j][1] = 0;
            ...
            for (k = k + 1; k < 13; k++)
            {
                if (j & (1 << k))
                {
                    preMove.cannonSupCol[i][j][1] = k;//Sup炮吃子
                    break;
                }
            }
           ...
           for(k=i-1;k>=3;k--)//向上寻找
            ...
            for (k = k - 1; k >= 3; k--)
            {
                if (j & (1 << k))
                {
                    preMove.cannonSupCol[i][j][0] = k;//Sup炮吃子
                    break;
                }
            }
